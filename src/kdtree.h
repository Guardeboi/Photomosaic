...
class KDTree
{
  ...
  public:
    ...
    void BuildRecursive(RandIter start, RandIter end, int dim, KDTreeNode*& tmp);
    ...
    KDTreeNode* NeighborRecursive(const Point<Dim>& query, KDTreeNode* node, int dim, KDTreeNode*& bestNode ) const;
